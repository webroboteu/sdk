 ...
 */
public final class ApiGatewayProtocolFactoryUploadImpl implements SdkJsonMarshallerFactory {
    ...
    public ApiGatewayProtocolFactoryUploadImpl(JsonClientMetadata metadata) {
