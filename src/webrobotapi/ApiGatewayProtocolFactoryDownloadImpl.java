 ...
 */
public final class ApiGatewayProtocolFactoryDownloadImpl implements SdkJsonMarshallerFactory {
    ...
    public ApiGatewayProtocolFactoryDownloadImpl(JsonClientMetadata metadata) {
