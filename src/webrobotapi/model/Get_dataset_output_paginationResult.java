...
public class Get_dataset_output_paginationResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public Get_dataset_output_paginationResult arrayOfDatasetRecord(DatasetRecord... arrayOfDatasetRecord) {
    ...
    public Get_dataset_output_paginationResult arrayOfDatasetRecord(java.util.Collection<DatasetRecord> arrayOfDatasetRecord) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_dataset_output_paginationResult == false)
            return false;
        Get_dataset_output_paginationResult other = (Get_dataset_output_paginationResult) obj;
    ...
    @Override
    public Get_dataset_output_paginationResult clone() {
        try {
            return (Get_dataset_output_paginationResult) super.clone();
