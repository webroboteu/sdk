...
public class Get_dataset_paginationResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public Get_dataset_paginationResult arrayOfDatasetRecord(DatasetRecord... arrayOfDatasetRecord) {
    ...
    public Get_dataset_paginationResult arrayOfDatasetRecord(java.util.Collection<DatasetRecord> arrayOfDatasetRecord) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_dataset_paginationResult == false)
            return false;
        Get_dataset_paginationResult other = (Get_dataset_paginationResult) obj;
    ...
    @Override
    public Get_dataset_paginationResult clone() {
        try {
            return (Get_dataset_paginationResult) super.clone();
