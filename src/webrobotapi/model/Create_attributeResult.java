...
public class Create_attributeResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public Create_attributeResult conceptAttribute(ConceptAttribute conceptAttribute) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Create_attributeResult == false)
            return false;
        Create_attributeResult other = (Create_attributeResult) obj;
    ...
    @Override
    public Create_attributeResult clone() {
        try {
            return (Create_attributeResult) super.clone();
