...
public class Update_pageRequest extends com.amazonaws.opensdk.BaseRequest implements Serializable, Cloneable {
    ...
    public Update_pageRequest botId(String botId) {
        setBotId(botId);
        return this;
    }
    ...
    public Update_pageRequest conceptId(String conceptId) {
    ...
    public Update_pageRequest page(Page page) {
        setPage(page);
        return this;
    }
    ...
    public Update_pageRequest projectId(String projectId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Update_pageRequest == false)
            return false;
        Update_pageRequest other = (Update_pageRequest) obj;
    ...
    @Override
    public Update_pageRequest clone() {
        return (Update_pageRequest) super.clone();
    }
     ...
     */
    public Update_pageRequest sdkRequestConfig(com.amazonaws.opensdk.SdkRequestConfig sdkRequestConfig) {
