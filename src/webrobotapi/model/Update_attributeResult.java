...
public class Update_attributeResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public Update_attributeResult conceptAttribute(ConceptAttribute conceptAttribute) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Update_attributeResult == false)
            return false;
        Update_attributeResult other = (Update_attributeResult) obj;
    ...
    @Override
    public Update_attributeResult clone() {
        try {
            return (Update_attributeResult) super.clone();
