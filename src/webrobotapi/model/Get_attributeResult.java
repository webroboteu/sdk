...
public class Get_attributeResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public Get_attributeResult conceptAttribute(ConceptAttribute conceptAttribute) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_attributeResult == false)
            return false;
        Get_attributeResult other = (Get_attributeResult) obj;
    ...
    @Override
    public Get_attributeResult clone() {
        try {
            return (Get_attributeResult) super.clone();
