...
public class webrobotapiException extends com.amazonaws.SdkBaseException implements BaseException {
    ...
    /**
     * Constructs a new webrobotapiException with the specified error message.
     *
     * @param message
     *        Describes the error encountered.
     */
    public webrobotapiException(String message) {
        super(message);
        this.message = message;
    }

    @Override
    public webrobotapiException sdkHttpMetadata(SdkErrorHttpMetadata sdkHttpMetadata) {
