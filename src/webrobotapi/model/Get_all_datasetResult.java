...
public class Get_all_datasetResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public Get_all_datasetResult arrayOfBotDataset(BotDataset... arrayOfBotDataset) {
    ...
    public Get_all_datasetResult arrayOfBotDataset(java.util.Collection<BotDataset> arrayOfBotDataset) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_all_datasetResult == false)
            return false;
        Get_all_datasetResult other = (Get_all_datasetResult) obj;
    ...
    @Override
    public Get_all_datasetResult clone() {
        try {
            return (Get_all_datasetResult) super.clone();
