...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/90ngiz4uj1-1.0.0/Update_attribute" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class Update_attributeRequest extends com.amazonaws.opensdk.BaseRequest implements Serializable, Cloneable {
    ...
    public Update_attributeRequest botId(String botId) {
        setBotId(botId);
        return this;
    }
    ...
    public Update_attributeRequest conceptAttribute(ConceptAttribute conceptAttribute) {
    ...
    public Update_attributeRequest conceptId(String conceptId) {
    ...
    public Update_attributeRequest projectId(String projectId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Update_attributeRequest == false)
            return false;
        Update_attributeRequest other = (Update_attributeRequest) obj;
    ...
    @Override
    public Update_attributeRequest clone() {
        return (Update_attributeRequest) super.clone();
    }
     ...
     */
    public Update_attributeRequest sdkRequestConfig(com.amazonaws.opensdk.SdkRequestConfig sdkRequestConfig) {
